...
"use strict";
eval("\n\nvar _assoc = __webpack_require__(/*! ramda/src/assoc */ 46);\n\nvar _assoc2 = _interopRequireDefault(_assoc);\n\nvar _compose = __webpack_require__(/*! ramda/src/compose */ 47);\n\nvar _compose2 = _interopRequireDefault(_compose);\n\nvar _curry = __webpack_require__(/*! ramda/src/curry */ 55);\n\nvar _curry2 = _interopRequireDefault(_curry);\n\nvar _equals = __webpack_require__(/*! ramda/src/equals */ 57);\n\nvar _equals2 = _interopRequireDefault(_equals);\n\nvar _filter = __webpack_require__(/*! ramda/src/filter */ 64);\n\nvar _filter2 = _interopRequireDefault(_filter);\n\nvar _map = __webpack_require__(/*! ramda/src/map */ 69);\n\nvar _map2 = _interopRequireDefault(_map);\n\nvar _merge = __webpack_require__(/*! ramda/src/merge */ 72);\n\nvar _merge2 = _interopRequireDefault(_merge);\n\nvar _pipe = __webpack_require__(/*! ramda/src/pipe */ 26);\n\nvar _pipe2 = _interopRequireDefault(_pipe);\n\nvar _reduce = __webpack_require__(/*! ramda/src/reduce */ 27);\n\nvar _reduce2 = _interopRequireDefault(_reduce);\n\nvar _zipObj = __webpack_require__(/*! ramda/src/zipObj */ 75);\n\nvar _zipObj2 = _interopRequireDefault(_zipObj);\n\nvar _Observable = __webpack_require__(/*! rxjs/Observable */ 0);\n\nvar _Subject = __webpack_require__(/*! rxjs/Subject */ 23);\n\nvar _ReplaySubject = __webpack_require__(/*! rxjs/ReplaySubject */ 40);\n\n__webpack_require__(/*! rxjs/add/observable/combineLatest */ 88);\n\n__webpack_require__(/*! rxjs/add/observable/merge */ 95);\n\n__webpack_require__(/*! rxjs/add/observable/of */ 98);\n\n__webpack_require__(/*! rxjs/add/operator/distinctUntilChanged */ 100);\n\n__webpack_require__(/*! rxjs/add/operator/do */ 102);\n\n__webpack_require__(/*! rxjs/add/operator/filter */ 104);\n\n__webpack_require__(/*! rxjs/add/operator/map */ 106);\n\n__webpack_require__(/*! rxjs/add/operator/pluck */ 107);\n\n__webpack_require__(/*! rxjs/add/operator/sample */ 109);\n\n__webpack_require__(/*! rxjs/add/operator/scan */ 111);\n\n__webpack_require__(/*! rxjs/add/operator/shareReplay */ 113);\n\n__webpack_require__(/*! rxjs/add/operator/startWith */ 117);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n// RAMDA ===========================================================================================\nvar id = function id(x) {\n            return x;\n};\nvar always = (0, _curry2.default)(function (x, y) {\n            return x;\n});\n\nwindow.R = { always: always, assoc: _assoc2.default, compose: _compose2.default, curry: _curry2.default, equals: _equals2.default, id: id, filter: _filter2.default,\n            map: _map2.default, merge: _merge2.default, pipe: _pipe2.default, reduce: _reduce2.default, zipObj: _zipObj2.default\n\n            // RXJS ============================================================================================\n};\n\n// Observable functions\n\n\n// Observable methods\n\n\nwindow.Observable = _Observable.Observable;\nwindow.Subject = _Subject.Subject;\nwindow.ReplaySubject = _ReplaySubject.ReplaySubject;\n\n//////////////////\n// WEBPACK FOOTER\n// ./client-2/vendors.js\n// module id = 45\n// module chunks = 0\n\n//# sourceURL=webpack:///./client-2/vendors.js?");
...
eval("var _checkForMethod = __webpack_require__(/*! ./internal/_checkForMethod */ 29);\nvar _curry1 = __webpack_require__(/*! ./internal/_curry1 */ 3);\nvar slice = __webpack_require__(/*! ./slice */ 53);\n\n/**\n * Returns all but the first element of the given list or string (or object\n * with a `tail` method).\n *\n * Dispatches to the `slice` method of the first argument, if present.\n *\n * @func\n * @memberOf R\n * @since v0.1.0\n * @category List\n * @sig [a] -> [a]\n * @sig String -> String\n * @param {*} list\n * @return {*}\n * @see R.head, R.init, R.last\n * @example\n *\n *      R.tail([1, 2, 3]);  //=> [2, 3]\n *      R.tail([1, 2]);     //=> [2]\n *      R.tail([1]);        //=> []\n *      R.tail([]);         //=> []\n *\n *      R.tail('abc');  //=> 'bc'\n *      R.tail('ab');   //=> 'b'\n *      R.tail('a');    //=> ''\n *      R.tail('');     //=> ''\n */\nmodule.exports = _curry1(_checkForMethod('tail', slice(1, Infinity)));\n\n//////////////////\n// WEBPACK FOOTER\n// /Users/ivankleshnin/node_modules/ramda/src/tail.js\n// module id = 52\n// module chunks = 0\n\n//# sourceURL=webpack:////Users/ivankleshnin/node_modules/ramda/src/tail.js?");
...
eval("var _arrayFromIterator = __webpack_require__(/*! ./_arrayFromIterator */ 59);\nvar _functionName = __webpack_require__(/*! ./_functionName */ 60);\nvar _has = __webpack_require__(/*! ./_has */ 11);\nvar identical = __webpack_require__(/*! ../identical */ 61);\nvar keys = __webpack_require__(/*! ../keys */ 19);\nvar type = __webpack_require__(/*! ../type */ 63);\n\nmodule.exports = function _equals(a, b, stackA, stackB) {\n  if (identical(a, b)) {\n    return true;\n  }\n\n  if (type(a) !== type(b)) {\n    return false;\n  }\n\n  if (a == null || b == null) {\n    return false;\n  }\n\n  if (typeof a.equals === 'function' || typeof b.equals === 'function') {\n    return typeof a.equals === 'function' && a.equals(b) && typeof b.equals === 'function' && b.equals(a);\n  }\n\n  switch (type(a)) {\n    case 'Arguments':\n    case 'Array':\n    case 'Object':\n      if (typeof a.constructor === 'function' && _functionName(a.constructor) === 'Promise') {\n        return a === b;\n      }\n      break;\n    case 'Boolean':\n    case 'Number':\n    case 'String':\n      if (!(typeof a === typeof b && identical(a.valueOf(), b.valueOf()))) {\n        return false;\n      }\n      break;\n    case 'Date':\n      if (!identical(a.valueOf(), b.valueOf())) {\n        return false;\n      }\n      break;\n    case 'Error':\n      return a.name === b.name && a.message === b.message;\n    case 'RegExp':\n      if (!(a.source === b.source && a.global === b.global && a.ignoreCase === b.ignoreCase && a.multiline === b.multiline && a.sticky === b.sticky && a.unicode === b.unicode)) {\n        return false;\n      }\n      break;\n    case 'Map':\n    case 'Set':\n      if (!_equals(_arrayFromIterator(a.entries()), _arrayFromIterator(b.entries()), stackA, stackB)) {\n        return false;\n      }\n      break;\n    case 'Int8Array':\n    case 'Uint8Array':\n    case 'Uint8ClampedArray':\n    case 'Int16Array':\n    case 'Uint16Array':\n    case 'Int32Array':\n    case 'Uint32Array':\n    case 'Float32Array':\n    case 'Float64Array':\n      break;\n    case 'ArrayBuffer':\n      break;\n    default:\n      // Values of other types are only equal if identical.\n      return false;\n  }\n\n  var keysA = keys(a);\n  if (keysA.length !== keys(b).length) {\n    return false;\n  }\n\n  var idx = stackA.length - 1;\n  while (idx >= 0) {\n    if (stackA[idx] === a) {\n      return stackB[idx] === b;\n    }\n    idx -= 1;\n  }\n\n  stackA.push(a);\n  stackB.push(b);\n  idx = keysA.length - 1;\n  while (idx >= 0) {\n    var key = keysA[idx];\n    if (!(_has(key, b) && _equals(b[key], a[key], stackA, stackB))) {\n      return false;\n    }\n    idx -= 1;\n  }\n  stackA.pop();\n  stackB.pop();\n  return true;\n};\n\n//////////////////\n// WEBPACK FOOTER\n// /Users/ivankleshnin/node_modules/ramda/src/internal/_equals.js\n// module id = 58\n// module chunks = 0\n\n//# sourceURL=webpack:////Users/ivankleshnin/node_modules/ramda/src/internal/_equals.js?");
...
eval("var _curry2 = __webpack_require__(/*! ./internal/_curry2 */ 1);\nvar _dispatchable = __webpack_require__(/*! ./internal/_dispatchable */ 31);\nvar _filter = __webpack_require__(/*! ./internal/_filter */ 66);\nvar _isObject = __webpack_require__(/*! ./internal/_isObject */ 67);\nvar _reduce = __webpack_require__(/*! ./internal/_reduce */ 17);\nvar _xfilter = __webpack_require__(/*! ./internal/_xfilter */ 68);\nvar keys = __webpack_require__(/*! ./keys */ 19);\n\n/**\n * Takes a predicate and a \"filterable\", and returns a new filterable of the\n * same type containing the members of the given filterable which satisfy the\n * given predicate.\n *\n * Dispatches to the `filter` method of the second argument, if present.\n *\n * Acts as a transducer if a transformer is given in list position.\n *\n * @func\n * @memberOf R\n * @since v0.1.0\n * @category List\n * @sig Filterable f => (a -> Boolean) -> f a -> f a\n * @param {Function} pred\n * @param {Array} filterable\n * @return {Array}\n * @see R.reject, R.transduce, R.addIndex\n * @example\n *\n *      var isEven = n => n % 2 === 0;\n *\n *      R.filter(isEven, [1, 2, 3, 4]); //=> [2, 4]\n *\n *      R.filter(isEven, {a: 1, b: 2, c: 3, d: 4}); //=> {b: 2, d: 4}\n */\nmodule.exports = _curry2(_dispatchable(['filter'], _xfilter, function (pred, filterable) {\n  return _isObject(filterable) ? _reduce(function (acc, key) {\n    if (pred(filterable[key])) {\n      acc[key] = filterable[key];\n    }\n    return acc;\n  }, {}, keys(filterable)) :\n  // else\n  _filter(pred, filterable);\n}));\n\n//////////////////\n// WEBPACK FOOTER\n// /Users/ivankleshnin/node_modules/ramda/src/filter.js\n// module id = 64\n// module chunks = 0\n\n//# sourceURL=webpack:////Users/ivankleshnin/node_modules/ramda/src/filter.js?");
...
"use strict";
eval("\n\nvar ArrayObservable_1 = __webpack_require__(/*! ../observable/ArrayObservable */ 6);\nvar ScalarObservable_1 = __webpack_require__(/*! ../observable/ScalarObservable */ 41);\nvar EmptyObservable_1 = __webpack_require__(/*! ../observable/EmptyObservable */ 42);\nvar concat_1 = __webpack_require__(/*! ./concat */ 119);\nvar isScheduler_1 = __webpack_require__(/*! ../util/isScheduler */ 8);\n/* tslint:enable:max-line-length */\n/**\n * Returns an Observable that emits the items you specify as arguments before it begins to emit\n * items emitted by the source Observable.\n *\n * <img src=\"./img/startWith.png\" width=\"100%\">\n *\n * @param {...T} values - Items you want the modified Observable to emit first.\n * @param {Scheduler} [scheduler] - A {@link IScheduler} to use for scheduling\n * the emissions of the `next` notifications.\n * @return {Observable} An Observable that emits the items in the specified Iterable and then emits the items\n * emitted by the source Observable.\n * @method startWith\n * @owner Observable\n */\nfunction startWith() {\n    var array = [];\n    for (var _i = 0; _i < arguments.length; _i++) {\n        array[_i - 0] = arguments[_i];\n    }\n    var scheduler = array[array.length - 1];\n    if (isScheduler_1.isScheduler(scheduler)) {\n        array.pop();\n    } else {\n        scheduler = null;\n    }\n    var len = array.length;\n    if (len === 1) {\n        return concat_1.concatStatic(new ScalarObservable_1.ScalarObservable(array[0], scheduler), this);\n    } else if (len > 1) {\n        return concat_1.concatStatic(new ArrayObservable_1.ArrayObservable(array, scheduler), this);\n    } else {\n        return concat_1.concatStatic(new EmptyObservable_1.EmptyObservable(scheduler), this);\n    }\n}\nexports.startWith = startWith;\n//# sourceMappingURL=startWith.js.map\n\n//////////////////\n// WEBPACK FOOTER\n// ./node_modules/rxjs/operator/startWith.js\n// module id = 118\n// module chunks = 0\n\n//# sourceURL=webpack:///./node_modules/rxjs/operator/startWith.js?");
