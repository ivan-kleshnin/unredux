...
eval("var _arity = __webpack_require__(/*! ./internal/_arity */ 13);\nvar _pipe = __webpack_require__(/*! ./internal/_pipe */ 56);\nvar reduce = __webpack_require__(/*! ./reduce */ 36);\nvar tail = __webpack_require__(/*! ./tail */ 60);\n\n/**\n * Performs left-to-right function composition. The leftmost function may have\n * any arity; the remaining functions must be unary.\n *\n * In some libraries this function is named `sequence`.\n *\n * **Note:** The result of pipe is not automatically curried.\n *\n * @func\n * @memberOf R\n * @since v0.1.0\n * @category Function\n * @sig (((a, b, ..., n) -> o), (o -> p), ..., (x -> y), (y -> z)) -> ((a, b, ..., n) -> z)\n * @param {...Function} functions\n * @return {Function}\n * @see R.compose\n * @example\n *\n *      var f = R.pipe(Math.pow, R.negate, R.inc);\n *\n *      f(3, 4); // -(3^4) + 1\n * @symb R.pipe(f, g, h)(a, b) = h(g(f(a, b)))\n */\nmodule.exports = function pipe() {\n  if (arguments.length === 0) {\n    throw new Error('pipe requires at least one argument');\n  }\n  return _arity(arguments[0].length, reduce(_pipe, arguments[0], tail(arguments)));\n};\n\n//////////////////\n// WEBPACK FOOTER\n// ../node_modules/ramda/src/pipe.js\n// module id = 35\n// module chunks = 0\n\n//# sourceURL=webpack:///../node_modules/ramda/src/pipe.js?");
...
"use strict";
eval("\n\nvar _append = __webpack_require__(/*! ramda/src/append */ 54);\n\nvar _append2 = _interopRequireDefault(_append);\n\nvar _compose = __webpack_require__(/*! ramda/src/compose */ 55);\n\nvar _compose2 = _interopRequireDefault(_compose);\n\nvar _curry = __webpack_require__(/*! ramda/src/curry */ 62);\n\nvar _curry2 = _interopRequireDefault(_curry);\n\nvar _equals = __webpack_require__(/*! ramda/src/equals */ 64);\n\nvar _equals2 = _interopRequireDefault(_equals);\n\nvar _filter = __webpack_require__(/*! ramda/src/filter */ 71);\n\nvar _filter2 = _interopRequireDefault(_filter);\n\nvar _find = __webpack_require__(/*! ramda/src/find */ 76);\n\nvar _find2 = _interopRequireDefault(_find);\n\nvar _findIndex = __webpack_require__(/*! ramda/src/findIndex */ 78);\n\nvar _findIndex2 = _interopRequireDefault(_findIndex);\n\nvar _head = __webpack_require__(/*! ramda/src/head */ 150);\n\nvar _head2 = _interopRequireDefault(_head);\n\nvar _lens = __webpack_require__(/*! ramda/src/lens */ 29);\n\nvar _lens2 = _interopRequireDefault(_lens);\n\nvar _lensIndex = __webpack_require__(/*! ramda/src/lensIndex */ 82);\n\nvar _lensIndex2 = _interopRequireDefault(_lensIndex);\n\nvar _lensProp = __webpack_require__(/*! ramda/src/lensProp */ 86);\n\nvar _lensProp2 = _interopRequireDefault(_lensProp);\n\nvar _map = __webpack_require__(/*! ramda/src/map */ 39);\n\nvar _map2 = _interopRequireDefault(_map);\n\nvar _merge = __webpack_require__(/*! ramda/src/merge */ 89);\n\nvar _merge2 = _interopRequireDefault(_merge);\n\nvar _over = __webpack_require__(/*! ramda/src/over */ 40);\n\nvar _over2 = _interopRequireDefault(_over);\n\nvar _pipe = __webpack_require__(/*! ramda/src/pipe */ 35);\n\nvar _pipe2 = _interopRequireDefault(_pipe);\n\nvar _prepend = __webpack_require__(/*! ramda/src/prepend */ 92);\n\nvar _prepend2 = _interopRequireDefault(_prepend);\n\nvar _reduce = __webpack_require__(/*! ramda/src/reduce */ 36);\n\nvar _reduce2 = _interopRequireDefault(_reduce);\n\nvar _repeat = __webpack_require__(/*! ramda/src/repeat */ 93);\n\nvar _repeat2 = _interopRequireDefault(_repeat);\n\nvar _set = __webpack_require__(/*! ramda/src/set */ 95);\n\nvar _set2 = _interopRequireDefault(_set);\n\nvar _slice = __webpack_require__(/*! ramda/src/slice */ 14);\n\nvar _slice2 = _interopRequireDefault(_slice);\n\nvar _sortBy = __webpack_require__(/*! ramda/src/sortBy */ 96);\n\nvar _sortBy2 = _interopRequireDefault(_sortBy);\n\nvar _tail = __webpack_require__(/*! ramda/src/tail */ 60);\n\nvar _tail2 = _interopRequireDefault(_tail);\n\nvar _take = __webpack_require__(/*! ramda/src/take */ 97);\n\nvar _take2 = _interopRequireDefault(_take);\n\nvar _takeLast = __webpack_require__(/*! ramda/src/takeLast */ 99);\n\nvar _takeLast2 = _interopRequireDefault(_takeLast);\n\nvar _view = __webpack_require__(/*! ramda/src/view */ 102);\n\nvar _view2 = _interopRequireDefault(_view);\n\nvar _zipObj = __webpack_require__(/*! ramda/src/zipObj */ 103);\n\nvar _zipObj2 = _interopRequireDefault(_zipObj);\n\nvar _Observable = __webpack_require__(/*! rxjs/Observable */ 1);\n\nvar _Subject = __webpack_require__(/*! rxjs/Subject */ 34);\n\nvar _ReplaySubject = __webpack_require__(/*! rxjs/ReplaySubject */ 48);\n\n__webpack_require__(/*! rxjs/add/observable/combineLatest */ 116);\n\n__webpack_require__(/*! rxjs/add/observable/merge */ 123);\n\n__webpack_require__(/*! rxjs/add/observable/of */ 126);\n\n__webpack_require__(/*! rxjs/add/operator/distinctUntilChanged */ 128);\n\n__webpack_require__(/*! rxjs/add/operator/do */ 130);\n\n__webpack_require__(/*! rxjs/add/operator/filter */ 132);\n\n__webpack_require__(/*! rxjs/add/operator/map */ 134);\n\n__webpack_require__(/*! rxjs/add/operator/pluck */ 135);\n\n__webpack_require__(/*! rxjs/add/operator/sample */ 137);\n\n__webpack_require__(/*! rxjs/add/operator/scan */ 139);\n\n__webpack_require__(/*! rxjs/add/operator/shareReplay */ 141);\n\n__webpack_require__(/*! rxjs/add/operator/startWith */ 145);\n\n__webpack_require__(/*! rxjs/add/operator/withLatestFrom */ 148);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n// RAMDA ===========================================================================================\nvar id = function id(x) {\n  return x;\n};\nvar always = (0, _curry2.default)(function (x, y) {\n  return x;\n});\n\nwindow.R = { always: always, append: _append2.default, compose: _compose2.default, curry: _curry2.default, equals: _equals2.default, id: id, filter: _filter2.default, find: _find2.default, findIndex: _findIndex2.default,\n  head: _head2.default, lens: _lens2.default, lensIndex: _lensIndex2.default, lensProp: _lensProp2.default, map: _map2.default, merge: _merge2.default, over: _over2.default, pipe: _pipe2.default, prepend: _prepend2.default,\n  repeat: _repeat2.default, reduce: _reduce2.default, set: _set2.default, slice: _slice2.default, sortBy: _sortBy2.default, tail: _tail2.default, take: _take2.default, takeLast: _takeLast2.default, view: _view2.default, zipObj: _zipObj2.default\n\n  // Helpers\n};var lensify = function lensify(lens) {\n  if (lens instanceof Array) {\n    return (0, _reduce2.default)(function (z, s) {\n      return (0, _compose2.default)(z, typeof s == \"number\" ? (0, _lensIndex2.default)(s) : (0, _lensProp2.default)(s));\n    }, id, lens);\n  } else if (lens instanceof Function) {\n    return lens;\n  } else {\n    throw Error(\"invalid lens \" + lens);\n  }\n};\n\n// Changing global namespace for brevity (bad for libs, ok for apps)\nwindow.R.viewL = (0, _curry2.default)(function (lens, obj) {\n  return (0, _view2.default)(lensify(lens), obj);\n});\nwindow.R.setL = (0, _curry2.default)(function (lens, val, obj) {\n  return (0, _set2.default)(lensify(lens), val, obj);\n});\nwindow.R.overL = (0, _curry2.default)(function (lens, fn, obj) {\n  return (0, _over2.default)(lensify(lens), fn, obj);\n});\n\n// RXJS ============================================================================================\n\n\n// Observable functions\n\n\n// Observable methods\n\n\nwindow.Observable = _Observable.Observable;\nwindow.Subject = _Subject.Subject;\nwindow.ReplaySubject = _ReplaySubject.ReplaySubject;\n\n//////////////////\n// WEBPACK FOOTER\n// ./client-1/vendors.js\n// module id = 53\n// module chunks = 0\n\n//# sourceURL=webpack:///./client-1/vendors.js?");
...
eval("var _curry1 = __webpack_require__(/*! ./internal/_curry1 */ 2);\nvar lens = __webpack_require__(/*! ./lens */ 29);\nvar nth = __webpack_require__(/*! ./nth */ 83);\nvar update = __webpack_require__(/*! ./update */ 84);\n\n/**\n * Returns a lens whose focus is the specified index.\n *\n * @func\n * @memberOf R\n * @since v0.14.0\n * @category Object\n * @typedefn Lens s a = Functor f => (a -> f a) -> s -> f s\n * @sig Number -> Lens s a\n * @param {Number} n\n * @return {Lens}\n * @see R.view, R.set, R.over\n * @example\n *\n *      var headLens = R.lensIndex(0);\n *\n *      R.view(headLens, ['a', 'b', 'c']);            //=> 'a'\n *      R.set(headLens, 'x', ['a', 'b', 'c']);        //=> ['x', 'b', 'c']\n *      R.over(headLens, R.toUpper, ['a', 'b', 'c']); //=> ['A', 'b', 'c']\n */\nmodule.exports = _curry1(function lensIndex(n) {\n  return lens(nth(n), update(n));\n});\n\n//////////////////\n// WEBPACK FOOTER\n// ../node_modules/ramda/src/lensIndex.js\n// module id = 82\n// module chunks = 0\n\n//# sourceURL=webpack:///../node_modules/ramda/src/lensIndex.js?");
...
"use strict";
eval("\n\nvar ArrayObservable_1 = __webpack_require__(/*! ../observable/ArrayObservable */ 9);\nvar ScalarObservable_1 = __webpack_require__(/*! ../observable/ScalarObservable */ 49);\nvar EmptyObservable_1 = __webpack_require__(/*! ../observable/EmptyObservable */ 50);\nvar concat_1 = __webpack_require__(/*! ./concat */ 147);\nvar isScheduler_1 = __webpack_require__(/*! ../util/isScheduler */ 11);\n/* tslint:enable:max-line-length */\n/**\n * Returns an Observable that emits the items you specify as arguments before it begins to emit\n * items emitted by the source Observable.\n *\n * <img src=\"./img/startWith.png\" width=\"100%\">\n *\n * @param {...T} values - Items you want the modified Observable to emit first.\n * @param {Scheduler} [scheduler] - A {@link IScheduler} to use for scheduling\n * the emissions of the `next` notifications.\n * @return {Observable} An Observable that emits the items in the specified Iterable and then emits the items\n * emitted by the source Observable.\n * @method startWith\n * @owner Observable\n */\nfunction startWith() {\n    var array = [];\n    for (var _i = 0; _i < arguments.length; _i++) {\n        array[_i - 0] = arguments[_i];\n    }\n    var scheduler = array[array.length - 1];\n    if (isScheduler_1.isScheduler(scheduler)) {\n        array.pop();\n    } else {\n        scheduler = null;\n    }\n    var len = array.length;\n    if (len === 1) {\n        return concat_1.concatStatic(new ScalarObservable_1.ScalarObservable(array[0], scheduler), this);\n    } else if (len > 1) {\n        return concat_1.concatStatic(new ArrayObservable_1.ArrayObservable(array, scheduler), this);\n    } else {\n        return concat_1.concatStatic(new EmptyObservable_1.EmptyObservable(scheduler), this);\n    }\n}\nexports.startWith = startWith;\n//# sourceMappingURL=startWith.js.map\n\n//////////////////\n// WEBPACK FOOTER\n// ./node_modules/rxjs/operator/startWith.js\n// module id = 146\n// module chunks = 0\n\n//# sourceURL=webpack:///./node_modules/rxjs/operator/startWith.js?");
